...
= 1.4.8.2 =
* Fixed js function, removed min js as it causes errors. will be added later.

= 1.4.8.1 =
* Fixed js function

= 1.4.8 =
* Major changes in js and php structure, removed old functions, cleaned up
...
= 1.4.5 =
* Fixed PHP notice when debug mode is activated, added plugin icon
