...
- Update: Refreshed MailChimp lib
- Bug fix: Fix circle countdown
- New: Add video autoplay support for mobile devices
- New: Expand youtube video link formats
- New: Add getresponse Mailing support
- New: Export emails to csv file
- New: Add some css effects


= 3.5.2 = (22.09.2017)
* Update: FontAwesome lib
* Update: Campaign monitor lib

= 3.5.1 = (04.07.2017)

* Bug fix: Js countdown in local time
* Bug fix: disable preloader option

= 3.5 = (12.06.2017)

* Bug fix: date_i18n + js datepicker
* Bug fix: scroll on big About text

= 3.4 = (11.04.2017)

* Bug fix: Add stripslashes function to subscribe form title
* Bug fix: Correct update fields with double quotes
* Bug fix: Revert apply_filter() in HTML popup
