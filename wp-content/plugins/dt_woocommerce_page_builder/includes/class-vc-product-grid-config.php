...
if ( ! class_exists( 'DTWPB_VcGridsCommon' ) ) {
	abstract class DTWPB_VcGridsCommon {
		...
		public static function getBasicAtts() {
			...
			if ( 'vc_edit_form' === vc_post_param( 'action' ) ) {
				$vcTaxonomiesTypes = vc_taxonomies_types(); var_dump($vcTaxonomiesTypes);
...
class DTWPB_WPBakeryShortCode_VC_Basic_Grid extends WPBakeryShortCode_VC_Basic_Grid{
...
class DTWPB_WPBakeryShortCode_VC_Product_Grid extends WPBakeryShortCode_VC_Basic_Grid {
	...
	public function GetSettings($name = 'base'){
