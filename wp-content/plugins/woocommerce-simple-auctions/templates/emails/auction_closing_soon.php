...
<?php
    printf(
        __("Auction <a href='%s'>%s</a> is going to be closed at %s. Current bid is %s", 'wc_simple_auctions'),
...
<p><small>
	<?php
	printf(
        __("To unsubscribe from ending soon emails <a href='%s'>click here</a>", 'wc_simple_auctions'),
        get_permalink( get_option('woocommerce_myaccount_page_id')).'/auctions-endpoint/'
