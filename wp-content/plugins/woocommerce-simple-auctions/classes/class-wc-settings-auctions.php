	...
	public function get_settings() {
		...
		return apply_filters( 'woocommerce_' . $this->id . '_settings', array(
			...
			array(	'title' => __( 'Simple auction options', 'wc_simple_auctions' ), 'type' => 'title','desc' => '', 'id' => 'simple_auction_options' ),
										// array(
										// 	'title' 			=> __( "Purchase code", 'wc_simple_auctions' ),
										// 	'desc'				=> __( "Envato purchase code for updating plugin.", 'wc_simple_auctions' ),
										// 	'type' 				=> 'text',
										// 	'id'				=> 'simple_auctions_purchase_code',
										// 	'default' 			=> ''
										// ),
										array(
...
Use upper-case characters for mandatory periods, or the corresponding lower-case characters for optional periods, i.e. only display if non-zero. Once one optional period is shown, all the ones after that are also shown.", 'wc_simple_auctions' ),
										...
										array(
											'title' 		=> __( "Ajax bid check only when in focus", 'wc_simple_auctions' ),
											'desc' 			=> __( 'Ajax bid check only when page / browser is in focus, if this is off it will trigger ajax request if page is open and user is not looking at it (increases server load).', 'wc_simple_auctions' ),
											'type' 			=> 'checkbox',
