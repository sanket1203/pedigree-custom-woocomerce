        ...
        image_file_frame.on('select', function () {
            ...
            selection.map(function (attachment) {
                ...
                if (attachment.url) {
                    ...
                    var div_error =  t.parent().parent().find('.ywcfav_thumbn_error'),
                        div_error_cont = div_error.find('.ywcfav_thumbn_error_container');

                    var width_image= parseInt( attachment.width);

                    div_error_cont.hide();
                    if( width_image<ywcfav.min_width ) {


                        if (!div_error_cont.length) {

                            var div_error_cont_html = '<div class="ywcfav_thumbn_error_container">' +
                                '<div class="ywcfav_icon_error">&nbsp;' + ywcfav.error_txt + '</div>' +
                                '<div class="ywcfav_txt_error">' + ywcfav.error_full_txt + '</div>' +
                                '</div>';

                            div_error.html(div_error_cont_html);
                        }
                        else
                            div_error_cont.show();
...
/*END AUDIO*/
    ...
    $(document).on('woocommerce_variations_loaded woocommerce_variations_added', function(){
        ...
        $(document).on('click', '.ywcfav_add_variable_video', function (e) {
            var t = $(this),
                container = t.closest('.woocommerce_variation'),
        ...
        $(document).on('click', '.ywcfav_variation_video_add_by_upload', function (e) {
            ...
            var t = $(this),
                container = t.closest('.woocommerce_variation').find('.variation_video_add_by_upload'),
                video_id = container.find('.ywcfav_variation_video_id'),
                button = t.closest('.woocommerce_variation').find('.ywcfav_add_variable_video');
    ...
    /* Custom style in plugin option*/
   $('#ywcfav_player_type_style').on('change', function () {

        var select = $(this).val(),
            main_color          =   $('#ywcfav_main_font_colors').parents('tr'),
            control_bg_color    =   $('#ywcfav_control_bg_color').parents('tr'),
            alpha_control_bg_col    = $('#ywcfav_control_bg_color_alpha').parents('tr'),
            slide_color          =   $('#ywcfav_slider_color').parents('tr'),
            slide_bg_col         =  $('#ywcfav_slider_bg_color').parents('tr'),
            slide_bg_alpha       =  $('#ywcfav_slider_bg_color_alpha').parents('tr'),
            big_play             =  $('#ywcfav_big_play_border_color').parents('tr');

         if( select == 'default' ){
                main_color.hide();
                control_bg_color.hide();
                alpha_control_bg_col.hide();
                slide_color.hide();
                slide_bg_col.hide();
                slide_bg_alpha.hide();
                big_play.hide();
                ...
                main_color.show();
                control_bg_color.show();
                alpha_control_bg_col.show();
                slide_color.show();
                slide_bg_col.show();
                slide_bg_alpha.show();
                big_play.show();
