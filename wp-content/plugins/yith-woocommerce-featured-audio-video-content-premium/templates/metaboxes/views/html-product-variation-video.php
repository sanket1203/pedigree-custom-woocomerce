...
?>
 ...
 <div class="img_field">
        ...
        <p class="form-row form-row-last ywcfav_thumbn_error">
        	 <?php if( $img_size[0]<$min_size['width'] ):?>
                          <span class="ywcfav_thumbn_error_container">
                                <span class="ywcfav_icon_error">&nbsp;<?php _e( 'WARNING','yith-woocommerce-featured-video' );?></span>
                              <?php $error_message = sprintf( '%s.<br>%s.', __( 'The thumbnail image is too small, in this way the featured image will show a grainy picture', 'yith-woocommerce-featured-video' ),
                                                                            __( 'Please, load a bigger thumbnail image', 'yith-woocommerce-featured-video' ) );?>
                                <span class="ywcfav_txt_error"><?php echo $error_message;?></span>
                          </span>
     <?php endif;?>
        </p>
</div>
