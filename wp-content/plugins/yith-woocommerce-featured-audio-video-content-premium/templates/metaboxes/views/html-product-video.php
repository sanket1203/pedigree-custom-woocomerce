        ...
        <table cellpadding="0" cellspacing="0">
            <tbody>
                <tr>
                    ...
                    <td class="ywcfav_thumbn_error">
                        <?php if( $img_size[0]<$min_size['width'] ):?>
                          <div class="ywcfav_thumbn_error_container">
                                <div class="ywcfav_icon_error">&nbsp;<?php _e( 'WARNING','yith-woocommerce-featured-video' );?></div>
                              <?php $error_message = sprintf( '%s.<br>%s.', __( 'The thumbnail image is too small, in this way the featured image will show a grainy picture', 'yith-woocommerce-featured-video' ),
                                ...
                                <div class="ywcfav_txt_error"><?php echo $error_message;?></div>
                          </div>
                        <?php endif;?>
                    </td>
                </tr>
